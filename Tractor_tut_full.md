...
the absolute file path of the **$SCRATCH** space is  ```/gpfs/fs0/scratch/HOST_FIRST_INITIAL/HOST_NAME/YOUR_SCINET_USERNAME/```
...
```
cp -r /gpfs/fs1/home/d/dfelsky/milicmil/Tractor/ /gpfs/fs0/scratch/HOST_FIRST_INITIAL/HOST_NAME/YOUR_SCINET_USERNAME/
```
...
```
cp -r /gpfs/fs1/home/d/dfelsky/milicmil/tutorial_data/ /gpfs/fs0/scratch/HOST_FIRST_INITIAL/HOST_NAME/YOUR_SCINET_USERNAME/
```
...
```
cp /gpfs/fs1/home/d/dfelsky/milicmil/tut_output/phase/ASW.phased.haps /gpfs/fs0/scratch/HOST_FIRST_INITIAL/HOST_NAME/YOUR_SCINET_USERNAME/tutorial_data/ADMIX_COHORT/

cp /gpfs/fs1/home/d/dfelsky/milicmil/tut_output/phase/ASW.phased.sample /gpfs/fs0/scratch/HOST_FIRST_INITIAL/HOST_NAME/YOUR_SCINET_USERNAME/tutorial_data/ADMIX_COHORT/
